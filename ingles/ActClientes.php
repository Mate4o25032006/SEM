...
<?php
  ...
  if(isset($_GET['ID'])){
    ...
    $query="SELECT * FROM clientes WHERE idDocumento='$ID'";
    $Consulta=$Conex->query($query);
    if(empty($Consulta)){
      echo"No existen Clientes con ese nombre";
    }else{
  ...
  <div class="container">
    <section class="main-section contact" id="contact">
      <div class="contact_section">
        <h2>Actualizar datos Clientes</h2>
      </div>
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          <div class="contact-info-box address clearfix">
            <h3>Info</h3>
            <p>Este es un formulario de Actualización de Clientes, acá podrá actualizar los datos que considere necesarios para su empresa.</p>
          </div>
        ...
        <div class="col-lg-6 wow fadeInUp delay-06s">
          <div class="form">    
            <form action="Conexiones/ActualizarClie.php" method="POST">

                <input class="input-text animated wow flipInY delay-02s" hidden="hidden" type="number" name="idDocumento" value="<?php echo $Fila['idDocumento'];?>"  >

                <input class="input-text animated wow flipInY delay-04s" type="text" name="Nombre" value="<?php echo $Fila['Nombre'];?>" >

                <input class="input-text animated wow flipInY delay-04s" type="text" name="Apellidos" value="<?php echo $Fila['Apellidos'];?>"  >
                ...
                <input class="input-btn animated wow flipInY delay-08s" type="submit" name="Actualizar" >
                <input class="input-btn animated wow flipInY delay-08s" type="reset" name="Borrar">
            </form>
          </div>
        </div>
      </div>

      ...
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          <div class="contact-info-box address clearfix">
            <h3>Info</h3>
            <p>This is a Product registration form, Here you can register entrepreneurship products, with this you will make them visible to people.</p>
          </div>
        ...
        <div class="col-lg-6 wow fadeInUp delay-06s">
          <div class="form">    
            <form action="Conexiones/ConProducto.php" method="POST" enctype="multipart/form-data">
              ...
              <option value="" selected>Seleccione your enterprise</option>
              <?php
              ...
              <input class="input-text animated wow flipInY delay-04s" type="text" name="Nom_Producto" value="Product Name *"  onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this. defaultValue;">
              ...
              <input class="input-text animated wow flipInY delay-04s" type="number" name="Precio" placeholder="Price *"  onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this. defaultValue;">

              <input class="input-text animated wow flipInY delay-04s" type="text" name="Descripcion" value="Description *"  onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this. defaultValue;">

              <input class="input-text animated wow flipInY delay-04s" type="text" name="Categoria" value="Category *"  onFocus="if(this.value==this.defaultValue)this.value='';" onBlur="if(this.value=='')this.value=this. defaultValue;">

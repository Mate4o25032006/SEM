...
function resizeText() {
    ...
    <title>Update Company Date</title>
</head>
<body>
<?php
  include "Navbar2.php";
  ...
  <div class="container">
    <section class="main-section contact" id="contact">
      <div class="contact_section">
        <h2>Update Company Date</h2>
      </div>
      <div class="row">
        <div class="col-lg-6 wow fadeInLeft">
          <div class="contact-info-box address clearfix">
            <h3>Info</h3>
            <p>This is a business update form, here you can update the data your deem necessary for your company.</p>
          </div>
        ...
        <div class="col-lg-6 wow fadeInUp delay-06s">
          <div class="form">    
            <form action="Conexiones/ActualizarEmp.php" method="POST" enctype="multipart/form-data">
                ...
                <input class="input-btn animated wow flipInY delay-08s" type="submit" name="Actualizar" value="Submit" style="background: #FF4500;">

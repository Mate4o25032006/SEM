...
<div class="container"> 
   ...
   <?php
       ...
       if (isset($_POST['Buscar']) && isset($_POST['TextoBuscar'])) {
         ...
         $Buscar="%$Buscar%";
         $query="SELECT * FROM clientes WHERE Nombre LIKE '$Buscar' OR
         Apellidos LIKE '$Buscar' OR Telefono LIKE '$Buscar' OR Correo LIKE '$Buscar' OR Direccion LIKE '$Buscar' ";
         ...
         if (mysqli_num_rows($Consulta) >= 1) {
           while($Fila=mysqli_fetch_array($Consulta)){ ?>
            <tr>
              ...
              <td data-titulo="Apellidos"><?php echo $Fila['Apellidos'] ?></td>
              <td data-titulo="Telefono"><?php echo $Fila['Telefono'] ?></td>
              <td data-titulo="Correo"><?php echo $Fila['Correo'] ?></td>
              <td data-titulo="Direccion"><?php echo $Fila['Direccion'] ?></td>
              <td data-titulo="Acciones"><a href="ActClientes.php?ID=<?php echo $Fila["idDocumento"] ?>">Editar</a>
               <a href="Conexiones/Eliminar">Eliminar</a>
             </td>
            </tr>
            <?php
           }

...
<?php
  ...
  if (isset($_SESSION['Correo'])){
    $user_query2 = $_SESSION['Correo'];
    $query="SELECT * FROM clientes WHERE Correo LIKE '$user_query2' "; 
...
<h2><b>Interfaz de <?php echo $Fila['Nombre'];?></b></h2>
  <div class="container">
    <div class="row">
      <h2>Empresas</h2>
      <div class="col-lg-4">
      ...
      <div class="col-lg-4">
        <div class="service_block">
          ...
          <h3 class="animated fadeInUp wow">Buscar Empresas</h3> 
          </a>
          <p>Esta Opción es para buscar Empresas.</p>
        </div>
      </div>
      ...
      <div class="col-lg-4">
        <div class="service_block">
          ...
          <h3 class="animated fadeInUp wow">Buscar Productos</h3> 
          </a>
          <p>Esta Opción es para buscar productos.</p>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        if (mysqli_num_rows($Consulta) >= 1) {
          while($Fila=mysqli_fetch_array($Consulta)){ ?>
            <div class="col-lg-4">
              <div class="service_block">
                <div> <img src="<?php echo $Fila['Imagen'] ?>" width="130px" height="120px" alt="Imagen Productos" style="border-radius:20px; "> </div>
                <p>-<?php echo $Fila[2] ?></p>

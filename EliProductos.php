        ...
        <div class="row">
          <div class="col-lg-6 wow fadeInLeft">
            <div class="contact-info-box address clearfix">
              <h3>Info</h3>
              <p>Este es un formulario de Eliminación de Productos, acá podrá eliminar lo que considere necesario.</p>
            </div>
          </div>
          <div class="col-lg-6 wow fadeInUp delay-06s">
            <div class="form">    
              <form action="Conexiones/EliProductos.php" method="POST" enctype="multipart/form-data">
                  ...
                  <input class="input-btn animated wow flipInY delay-08s" value="Eliminar" type="submit" name="Eliminar" style="background: #FF4500;">
              </form>
            </div>
          </div>
        </div>
